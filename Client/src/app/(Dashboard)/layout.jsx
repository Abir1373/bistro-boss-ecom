...
const DashboardLayout = ({ children }) => {
    ...
    if (user === null) return <span className="loading loading-spinner loading-lg"></span>
    else if (user !== null) { console.log(user.email) }
    let [data] = loadActiveUser(user.email)
    if (data === undefined) return <span className="loading loading-spinner loading-lg"></span>
    else {
        console.log(data)
        roleinfo = data.user_role
        return (
